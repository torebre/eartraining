...
<!--
	...
	the tip of a stick or beainternalLocationints, using Unicode arrow
	terminology.
-->
...
<!--
	...
	in which the tip of a beainternalLocationints.
-->
...
<!--
	...
	the direction in which the tip of a stinternalLocationints.
-->
...
<!--
	...
	startinternalLocationints. Values include:
