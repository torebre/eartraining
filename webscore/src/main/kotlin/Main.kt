...
fun main(args: Array<String>) {
    ...
    val note1 = NoteElement(NoteType.C, 5, Duration.QUARTER, 0, 0, "note-$idCounter")
    ++idCounter
    val note2 = NoteElement(NoteType.D, 5, Duration.QUARTER, 0, 0, "note-$idCounter")
    note2.tie = note1.id
    note2.accidental = Accidental.SHARP
    ++idCounter
    val rest1 = RestElement(Duration.QUARTER, 0, 0, "rest-$idCounter")
    ++idCounter
    val rest2 = RestElement(Duration.QUARTER, 0, 0, "rest-$idCounter")
