...
class WebScoreScoreHandlerStateBackend(
    private val scoreHandler: ScoreHandlerWithState,
    ...
    private var currentJsonScore: String? = null
    ...
    private fun handleKeyEvent(code: String, keyCode: Int) {
        ...
        when (code) {
            ...
            "Numpad1", "Numpad2", "Numpad3", "Numpad4" -> {
                activeElement?.let {
                    applyOperationAndUpdateSvg(
                        UpdateElement(
                            it,
                            duration = ScoreHandlerUtilities.getDuration(keyCode - 96)
                        )
                    )
                    highLightActiveElement()
                }
...
//            }
            ...
            "Delete" -> {
                activeElement?.let {
                    ...
                    applyOperationAndUpdateSvg(DeleteElement(it))
