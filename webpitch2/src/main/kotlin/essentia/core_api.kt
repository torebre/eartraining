...
//    open fun audioBufferToMonoSignal(buffer: AudioBuffer): Float32Array
    open fun getAudioBufferFromURL(audioURL: String, webAudioCtx: Any): Promise<Any>
    open fun getAudioChannelDataFromURL(audioURL: String, webAudioCtx: Any, channel: Number = definedExternally): Promise<Float32Array>
    open fun audioBufferToMonoSignal(buffer: Any): Float32Array
    open fun shutdown()
