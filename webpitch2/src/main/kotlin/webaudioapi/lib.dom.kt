...
external interface AudioBuffer {
    fun copyFromChannel(destination: Float32Array, channelNumber: Number, startInChannel: Number = definedExternally)
    fun copyFromChannel(destination: Float32Array, channelNumber: Number)
    fun copyToChannel(source: Float32Array, channelNumber: Number, startInChannel: Number = definedExternally)
    fun copyToChannel(source: Float32Array, channelNumber: Number)
    var duration: Number
    var length: Number
    var numberOfChannels: Number
    var sampleRate: Number
...
external interface AudioContext : BaseAudioContext {
    ...
    var baseLatency: Number
    var outputLatency: Number
...
external interface AudioDestinationNode : AudioNode {
    var maxChannelCount: Number
}

external interface AudioListener {
    var forwardX: AudioParam
    var forwardY: AudioParam
    var forwardZ: AudioParam
    var positionX: AudioParam
    var positionY: AudioParam
    var positionZ: AudioParam
    var upX: AudioParam
    var upY: AudioParam
    var upZ: AudioParam
...
external interface BaseAudioContext : EventTarget {
    ...
    var sampleRate: Number
    var state: String /* "closed" | "running" | "suspended" */
...
external interface OfflineAudioContextEventMap : BaseAudioContextEventMap {
    var complete: OfflineAudioCompletionEvent
}

external interface OfflineAudioContext : BaseAudioContext {
    var length: Number
    var oncomplete: ((self: OfflineAudioContext, ev: OfflineAudioCompletionEvent) -> Any)?
    fun resume(): Promise<Unit>
    fun startRendering(): Promise<AudioBuffer>
    fun suspend(suspendTime: Number): Promise<Unit>
    fun <K : String> addEventListener(type: K, listener: (self: OfflineAudioContext, ev: Any) -> Any, options: Boolean = definedExternally)
    fun <K : String> addEventListener(type: K, listener: (self: OfflineAudioContext, ev: Any) -> Any)
    fun <K : String> addEventListener(type: K, listener: (self: OfflineAudioContext, ev: Any) -> Any, options: AddEventListenerOptions = definedExternally)
    override fun addEventListener(type: String, listener: EventListener, options: Boolean)
    override fun addEventListener(type: String, listener: EventListener)
    override fun addEventListener(type: String, listener: EventListener, options: AddEventListenerOptions)
    override fun addEventListener(type: String, listener: EventListenerObject, options: Boolean)
    override fun addEventListener(type: String, listener: EventListenerObject)
    override fun addEventListener(type: String, listener: EventListenerObject, options: AddEventListenerOptions)
    fun <K : String> removeEventListener(type: K, listener: (self: OfflineAudioContext, ev: Any) -> Any, options: Boolean = definedExternally)
    fun <K : String> removeEventListener(type: K, listener: (self: OfflineAudioContext, ev: Any) -> Any)
    fun <K : String> removeEventListener(type: K, listener: (self: OfflineAudioContext, ev: Any) -> Any, options: EventListenerOptions = definedExternally)
    override fun removeEventListener(type: String, listener: EventListener, options: Boolean)
    override fun removeEventListener(type: String, listener: EventListener)
    override fun removeEventListener(type: String, listener: EventListener, options: EventListenerOptions)
    override fun removeEventListener(type: String, listener: EventListenerObject, options: Boolean)
...
external interface PannerNode : AudioNode {
    ...
    var distanceModel: String /* "exponential" | "inverse" | "linear" */
    var maxDistance: Number
    var orientationX: AudioParam
    var orientationY: AudioParam
    var orientationZ: AudioParam
    var panningModel: String /* "HRTF" | "equalpower" */
    var positionX: AudioParam
    var positionY: AudioParam
    var positionZ: AudioParam
